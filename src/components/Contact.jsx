        ...
        >
          <label className="flex flex-col">
            ...
            <input
              ...
              className="bg-tertiary py-4 px-6 placehloder:text-secondary text-white rounded-lg outlined-none border-none font-medium"
            />
          </label>
          <label className="flex flex-col">
